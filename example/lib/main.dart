...
const String BASIC_EXAMPLE_SUB = 'Open a PDF Document.';
const String IMAGE_DOCUMENT = 'Image Document';
const String IMAGE_DOCUMENT_SUB = 'Open an image document.';
const String DARK_THEME = 'Dark Theme';
const String DARK_THEME_SUB = 'Open a document in night mode with custom dark theme.';
const String CUSTOM_CONFIGURATION = 'Custom configuration options';
const String CUSTOM_CONFIGURATION_SUB = 'Open a document with custom configuration options.';
